...
if ( ! function_exists( 'signify_setup' ) ) :
	...
	function signify_setup() {
		...
		add_theme_support(
			...
			array(
				array(
					'name'      => esc_html__( 'Extra small', 'signify' ),
					'shortName' => esc_html__( 'XSS', 'signify' ),
					'size'      => 13,
					'slug'      => 'extra-small',
				),
				array(
		...
		add_theme_support(
			...
			array(
				...
				array(
					'name'  => esc_html__( 'Bright Pink', 'signify' ),
					'slug'  => 'bright-pink',
					'color' => '#f5808c',
				),
				array(
				...
				array(
					'name'  => esc_html__( 'Red', 'signify' ),
					'slug'  => 'red',
					'color' => '#db4f3d',
				),
				array(
					'name'  => esc_html__( 'Blue', 'signify' ),
					'slug'  => 'blue',
					'color' => '#008ec2',
				),
				array(
					'name'  => esc_html__( 'Dark Blue', 'signify' ),
					'slug'  => 'dark-blue',
					'color' => '#133ec2',
				),
			)
...
function signify_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'signify_content_width', 880 );
}
